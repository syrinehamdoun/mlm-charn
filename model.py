...
def preprocess_data(data):
    ...
    data['Anciennete'] = ((date_actuelle.year - data['Date_inscription'].dt.year) * 12 + date_actuelle.month - data[
        'Date_inscription'].dt.month).fillna(0).astype(int)
    ...
    numeric_features = ['Anciennete', 'Nb_fois_actif', 'CP', 'CE', 'Nb_fils_direct', 'Nb_fils', 'NB_cheque',
                        'Prime_parrainage', 'Prime_animation']
